...
class Meeting(models.Model):
    HISTORY_LOVE = (("Да", "Да"), ("Нет", "Нет"), ("Никогда", "Никогда"))
    ...
    history_love = models.CharField(
        "Были ли вы в отношениях?", max_length=100, choices=HISTORY_LOVE
    )
    purpose_of_dating = models.CharField(
        "Цель знакомства?", max_length=100, choices=P_OF_D
    )
...
class Reviews(models.Model):
    name_reviews = models.ForeignKey(
        Meeting, on_delete=models.CASCADE, related_name="comment_object"
    )
